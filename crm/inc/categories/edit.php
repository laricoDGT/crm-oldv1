...
if (isset($_POST['submit_edit'])) {
    ...
    if (!empty($data['category_name'])) {
        ...
        display_message('updated', 'Category updated successfully.');
...
<div class="form form-category add-edit-category">
    ...
    <form method="post" action="">
        ...
        <?php display_cat_form_fields($contact); ?>
...
<?php
        ...
        display_message('error', 'Category not found.');
    }
} else {
    display_message('error', 'No category information provided.');
}
?>
